...
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", Number)
], ServiceEntity.prototype, "contact", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => provider_entity_1.ProviderEntity, Provider => Provider.Services, { onDelete: "CASCADE" }),
    (0, typeorm_1.JoinColumn)({ name: 'ProviderID' }),
    __metadata("design:type", provider_entity_1.ProviderEntity)
], ServiceEntity.prototype, "Provider", void 0);
exports.ServiceEntity = ServiceEntity = __decorate([
    (0, typeorm_1.Entity)('Service Table')
], ServiceEntity);
